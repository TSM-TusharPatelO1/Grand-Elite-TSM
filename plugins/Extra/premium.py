...
async def give_premium_cmd_handler(client, message):
    ...
    if len(message.command) == 3:
        ...
        if seconds > 0:
            ...
            await message.reply_text(f"<b>ᴘʀᴇᴍɪᴜᴍ ᴀᴅᴅᴇᴅ ꜱᴜᴄᴄᴇꜱꜱꜰᴜʟʟʏ ᴛᴏ ᴛʜᴇ ᴜꜱᴇʀꜱ.</b>\n👤 <b>ᴜꜱᴇʀ ɴᴀᴍᴇ :</b> {user.mention}\n⚡ <b>ᴜꜱᴇʀ ɪᴅ :</b> {user.id}\n⏰ <b>ᴘʀᴇᴍɪᴜᴍ ᴀᴄᴄᴇꜱꜱ :</b> {time}")
            time_zone = datetime.datetime.now(pytz.timezone("Asia/Kolkata"))
            current_time = time_zone.strftime("%d-%m-%Y\n⏱️ <b>ᴊᴏɪɴɪɴɢ ᴛɪᴍᴇ :</b> %I:%M:%S %p")            
            expiry = expiry_time   
            expiry_str_in_ist = expiry.astimezone(pytz.timezone("Asia/Kolkata")).strftime("%d-%m-%Y\n⏱️ <b>ᴇxᴘɪʀʏ ᴛɪᴍᴇ :</b> %I:%M:%S %p")  
            await client.send_message(
                chat_id=user_id,
                text=f"<b>ᴘʀᴇᴍɪᴜᴍ ᴀᴅᴅᴇᴅ ᴛᴏ ʏᴏᴜʀ ᴀᴄᴄᴏᴜɴᴛ ꜰᴏʀ {time} ᴇɴᴊᴏʏ</b> 😀\n\n⏳ <b>ᴊᴏɪɴɪɴɢ ᴅᴀᴛᴇ :</b> {current_time}\n\n⌛️ <b>ᴇxᴘɪʀʏ ᴅᴀᴛᴇ :</b> {expiry_str_in_ist}",                
            )
            #user = await client.get_users(user_id)
            await client.send_message(LOG_CHANNEL, text=f"#Added_Premium\n\n👤 <b>ᴜꜱᴇʀ :</b> {user.mention}\n⚡ <b>ᴜꜱᴇʀ ɪᴅ :</b> {user.id}\n⏰ <b>ᴘʀᴇᴍɪᴜᴍ ᴀᴄᴄᴇꜱꜱ :</b> {time}\n\n⏳ <b>ᴊᴏɪɴɪɴɢ ᴅᴀᴛᴇ :</b> {current_time}\n\n⌛️ <b>ᴇxᴘɪʀʏ ᴅᴀᴛᴇ :</b> {expiry_str_in_ist}", disable_web_page_preview=True)
...
async def check_plans_cmd(client, message):
    ...
    if await db.has_premium_access(user_id):         
        ...
        await message.reply_text(f"📝 <b><u>ʏᴏᴜʀ ᴘʀᴇᴍɪᴜᴍ ꜱᴜʙꜱᴄʀɪᴘᴛɪᴏɴ ᴅᴇᴛᴀɪʟꜱ</u></b> :\n\n👤 <b>ᴜꜱᴇʀ ɴᴀᴍᴇ :</b> {user}\n🏷️ <b>ᴜꜱᴇʀ ɪᴅ :</b> <code>{user_id}</code>\n⏱️ <b>ᴇxᴘɪʀʏ ᴅᴀᴛᴇ :</b> {expiry_date}\n⏰ <b>ᴇxᴘɪʀʏ ᴛɪᴍᴇ :</b> {expiry_time}\n⏳ <b>ʀᴇᴍᴀɪɴɪɴɢ ᴛɪᴍᴇ :</b> {formatted_remaining_time}")
    else:
        btn = [ 
