...
<b>𝙹𝚞𝚜𝚝 𝚌𝚕𝚒𝚌𝚔 𝚝𝚑𝚎 𝚊𝚋𝚘𝚟𝚎 𝚌𝚘𝚍𝚎 𝚝𝚘 𝚌𝚘𝚙𝚢 𝚊𝚗𝚍 𝚝𝚑𝚎𝚗 𝚜𝚎𝚗𝚍 𝚝𝚑𝚊𝚝 𝚌𝚘𝚍𝚎 𝚝𝚘 𝚝𝚑𝚎 𝙱𝚘𝚝, 𝚝𝚑𝚊𝚝'𝚜 𝚒𝚝 🔥</b>"""
        ...
        keyboard = InlineKeyboardMarkup(
            [
                [InlineKeyboardButton("♻️ Redeem Here ♻️", url="http://t.me/Elite_TSM_bot")],
                [InlineKeyboardButton("❕ Any Query ❕", url="https://t.me/its_TSMSupport_bot")]
            ]
        )
        ...
        if redeem_code in VALID_REDEEM_CODES:
            try:
                ...
                if seconds > 0:
                    ...
                    await message.reply_text(
                        f"<b><i><u>Premium activated successfully</u> !</i></b>\n\n<b>User :</b> {user.mention}\n<b>User ID :</b> {user_id}\n<b>Premium Access :</b> <code>{time}</code>\n\n⏳ <b>Expiry Date :</b> {expiry_str_in_ist}",
                        disable_web_page_preview=True
                    )
