...
async def start(client:Client, message):
    ...
    if data and data.startswith("allfiles"):
        ...
        for file in files:
            ...
            btn = [[
                InlineKeyboardButton("📥 ᴅᴏᴡɴʟᴏᴀᴅ 📥 || 🌐 sᴛʀᴇᴀᴍ 🌐", callback_data=f'stream#{file.file_id}')
            ]]
        ...
        delCap = "<b><blockquote>IMPORTANT</blockquote></b>\n\nAʟʟ {} Mᴏᴠɪᴇ Fɪʟᴇs/Vɪᴅᴇᴏs ᴡɪʟʟ ʙᴇ Dᴇʟᴇᴛᴇᴅ ɪɴ <b>{}</b> 🥺 <i>(Due to Copyright Issues)</i>.\n\n<b><i>Please forward these Files/Videos to your Saved Messages and Start Download there</i></b>".format(len(files_to_delete), f'{FILE_AUTO_DEL_TIMER / 60} ᴍɪɴᴜᴛᴇs' if FILE_AUTO_DEL_TIMER >= 60 else f'{FILE_AUTO_DEL_TIMER} sᴇᴄᴏɴᴅs')
        afterDelCap = "<b>ᴀʟʟ {} ғɪʟᴇs ᴀʀᴇ ꜱᴜᴄᴄᴇꜱꜱғᴜʟʟʏ ᴅᴇʟᴇᴛᴇᴅ ᴀғᴛᴇʀ {} ᴛᴏ ᴀᴠᴏɪᴅ ᴄᴏᴘʏʀɪɢʜᴛ ᴠɪᴏʟᴀᴛɪᴏɴs !</b>".format(len(files_to_delete), f'{FILE_AUTO_DEL_TIMER / 60} ᴍɪɴᴜᴛᴇs' if FILE_AUTO_DEL_TIMER >= 60 else f'{FILE_AUTO_DEL_TIMER} sᴇᴄᴏɴᴅs')
    ...
    btn = [[
        InlineKeyboardButton("📥 ᴅᴏᴡɴʟᴏᴀᴅ 📥 || 🌐 sᴛʀᴇᴀᴍ 🌐", callback_data=f'stream#{file_id}')
    ]]
    toDel=await client.send_cached_media(
        chat_id=message.from_user.id,
        file_id=file_id,
    ...
    delCap = "<b><blockquote>IMPORTANT</blockquote></b>\n\nTʜɪs Mᴏᴠɪᴇ Fɪʟᴇ/Vɪᴅᴇᴏ ᴡɪʟʟ ʙᴇ Dᴇʟᴇᴛᴇᴅ ɪɴ <b>{}</b> 🥺 <i>(Due to Copyright Issues)</i>.\n\n<b><i>Please forward this File/Video to your Saved Messages and Start Download there</i></b>".format(f'{FILE_AUTO_DEL_TIMER / 60} ᴍɪɴᴜᴛᴇs' if FILE_AUTO_DEL_TIMER >= 60 else f'{FILE_AUTO_DEL_TIMER} sᴇᴄᴏɴᴅs')
    afterDelCap = "<b>ʏᴏᴜʀ ғɪʟᴇ ɪs ꜱᴜᴄᴄᴇꜱꜱғᴜʟʟʏ ᴅᴇʟᴇᴛᴇᴅ ᴀғᴛᴇʀ {} ᴛᴏ ᴀᴠᴏɪᴅ ᴄᴏᴘʏʀɪɢʜᴛ ᴠɪᴏʟᴀᴛɪᴏɴs !</b>".format(f'{FILE_AUTO_DEL_TIMER / 60} ᴍɪɴᴜᴛᴇs' if FILE_AUTO_DEL_TIMER >= 60 else f'{FILE_AUTO_DEL_TIMER} sᴇᴄᴏɴᴅs') 
    replyed = await message.reply(
        delCap,
...
async def send_request(bot, message):
    ...
    k = await message.reply_text("<b>✅ sᴜᴄᴄᴇssғᴜʟʟʏ ʏᴏᴜʀ ʀᴇǫᴜᴇsᴛ ʜᴀs ʙᴇᴇɴ ᴀᴅᴅᴇᴅ, ᴘʟᴇᴀsᴇ ᴡᴀɪᴛ sᴏᴍᴇᴛɪᴍᴇ...\n\nʏᴏᴜ ᴡɪʟʟ ʙᴇ ɴᴏᴛɪғɪᴇᴅ ᴡʜᴇɴ ᴛʜᴇ ᴍᴏᴠɪᴇ ᴏʀ sᴇʀɪᴇs ʏᴏᴜ ʀᴇǫᴜᴇsᴛᴇᴅ ɪꜱ ᴀᴠᴀɪʟᴀʙʟᴇ.</b>")
    await asyncio.sleep(600)
    await k.delete()
