 ...
 #   if user_id in ADMINS: return
    ...
    if await db.get_pm_search_status(bot_id):
        ...
        await message.reply_text("<b><i>ɪ ᴀᴍ ɴᴏᴛ ᴡᴏʀᴋɪɴɢ ʜᴇʀᴇ. ꜱᴇᴀʀᴄʜ ᴍᴏᴠɪᴇꜱ ɪɴ ᴏᴜʀ ᴍᴏᴠɪᴇ ꜱᴇᴀʀᴄʜ ɢʀᴏᴜᴘ.</i></b>",
                                 reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("📝 ᴍᴏᴠɪᴇ ꜱᴇᴀʀᴄʜ ɢʀᴏᴜᴘ ", url=f'https://t.me/ShadowMonarch_Group')]]))
...
async def refercall(bot, query):
    ...
    await bot.send_photo(
        ...
        caption=f'<b>ʀᴇғᴇʀ ʏᴏᴜʀ ʟɪɴᴋ ᴛᴏ ʏᴏᴜʀ ғʀɪᴇɴᴅs, ғᴀᴍɪʟʏ, ᴄʜᴀɴɴᴇʟ ᴀɴᴅ ɢʀᴏᴜᴘ ᴛᴏ ɢᴇᴛ ғʀᴇᴇ ᴘʀᴇᴍɪᴜᴍ\n\nʀᴇғᴇʀʀᴀʟ ʟɪɴᴋ - https://t.me/{bot.me.username}?start=reff_{query.from_user.id}\n\nᴇᴀᴄʜ ᴛɪᴍᴇ ᴛʜᴇʏ Jᴏɪɴ, ʏᴏᴜ ᴡɪʟʟ ɢᴇᴛ 𝟷𝟶 ʀᴇғᴇʀʀᴀʟ ᴘᴏɪɴᴛꜱ ᴀɴᴅ ᴀғᴛᴇʀ 𝟷𝟶𝟶 ᴘᴏɪɴᴛꜱ ʏᴏᴜ ᴡɪʟʟ ɢᴇᴛ 𝟷 ᴍᴏɴᴛʜ ᴘʀᴇᴍɪᴜᴍ ꜱᴜʙꜱᴄʀɪᴘᴛɪᴏɴ.</b>',
...
async def cb_handler(client: Client, query: CallbackQuery):
    if query.data == "close_data":
        ...
        if has_free_trial:
            ...
            await client.send_message(LOG_CHANNEL, text=f"#FREE_TRAIL_CLAIMED\n\n👤 <b>ᴜꜱᴇʀ ɴᴀᴍᴇ -</b> {query.from_user.mention}\n⚡ <b>ᴜꜱᴇʀ ɪᴅ -</b> {user_id}", disable_web_page_preview=True)
            return   
        ...
        buttons = [[
                ...
                InlineKeyboardButton("⚙️ ᴄᴏᴍᴍᴀɴᴅs", callback_data='features'),
                InlineKeyboardButton('💌 ᴀʙᴏᴜᴛ', callback_data=f'about')
                ],[
                InlineKeyboardButton('💝 ᴘʀᴇᴍɪᴜᴍs', callback_data='seeplans'),
                InlineKeyboardButton('🎁 ʀᴇғᴇʀʀᴀʟ', callback_data="reffff")
                ],[
                InlineKeyboardButton('📚 ᴜᴘᴅᴀᴛᴇs', url='https://t.me/ShadowMonarch_Updates'),
        ...
        btn = [[
            InlineKeyboardButton('🍁 Cʜᴇᴄᴋ Aʟʟ Pʟᴀɴs 🍁', callback_data='free')
        ],[
        ...
        buttons = [[
            InlineKeyboardButton('📸 Sᴇɴᴅ Sᴄʀᴇᴇɴꜱʜᴏᴛ 📸', url=f'https://t.me/its_TSMSupport_bot')
        ],[
            InlineKeyboardButton('Cᴜsᴛᴏᴍɪᴢᴇᴅ Pʟᴀɴ', callback_data='other')
        ],[
       ...
       await query.message.edit_media(
        ...
        buttons = [[
            InlineKeyboardButton('☎️ 𝗖𝗼𝗻𝘁𝗮𝗰𝘁 𝗢𝘄𝗻𝗲𝗿 𝗧𝗼 𝗞𝗻𝗼𝘄 𝗠𝗼𝗿𝗲', url="https://t.me/its_TSMSupport_bot")
        ],[
        ...
        buttons = [[
              InlineKeyboardButton('•︎ Aᴅᴍɪɴ Cᴏᴍᴍᴀɴᴅs •︎', callback_data='admincmd'),
              ], [
    ...
    # If the user isn't an admin, return
      if query.from_user.id not in ADMINS:
        return await query.answer('ᴛʜɪs ɪs ɴᴏᴛ ꜰᴏʀ ʏᴏᴜ ʙʀᴏ!', show_alert=True)
      ...
      await client.edit_message_media(
       ...
       await client.edit_message_media(
        ...
        await query.message.edit_text(
			...
			InlineKeyboardButton('•︎ ᴏᴡɴᴇʀ •︎', url="https://t.me/its_TSMSupport_bot"),
                        InlineKeyboardButton('•︎ ᴄʀᴇᴅɪᴛ •︎',callback_data='mydevelopers')
		],[
			InlineKeyboardButton('⇋︎ ʙᴀᴄᴋ ᴛᴏ ʜᴏᴍᴇ ⇋︎', callback_data='start')]]
                ),
            disable_web_page_preview = True
        ...
        await query.answer("ᴛʜɪꜱ ʙᴏᴛ ɪꜱ ɴᴏᴛ ᴅᴇᴠᴇʟᴏᴘᴇᴅ ʙʏ ᴍᴇ ᴀʟᴏɴᴇ. ɪᴛ ᴛᴏᴏᴋ ᴀ ʟᴏᴛ ᴏғ ᴛɪᴍᴇ ᴀɴᴅ ᴇғғᴏʀᴛ.\n\nᴛʜᴀɴᴋꜱ ᴛᴏ ᴇᴠᴇʀʏᴏɴᴇ ғᴏʀ ʜᴇʟᴘɪɴɢ ᴍᴇ ᴀ ʟᴏᴛ. 💝", show_alert=True)
	
    elif query.data == "disclaimer":
            btn = [[
                    InlineKeyboardButton("📲 ᴄᴏɴᴛᴀᴄᴛ ᴛᴏ ᴏᴡɴᴇʀ ", url="https://t.me/its_TSMSupport_bot")
               ],[
        ...
        if (st.status == enums.ChatMemberStatus.ADMINISTRATOR) or (st.status == enums.ChatMemberStatus.OWNER):
            ...
            await query.message.edit_reply_markup(InlineKeyboardMarkup(buttons))
            try:
                await client.send_message(chat_id=user_id, text="<b>sᴏʀʀʏ ʏᴏᴜʀ ʀᴇǫᴜᴇsᴛ ɪs ʀᴇᴊᴇᴄᴛᴇᴅ 😶</b>")
            except UserIsBlocked:
                await client.send_message(SUPPORT_GROUP, text=f"<b>💥 ʜᴇʟʟᴏ {user.mention},\n\nsᴏʀʀʏ ʏᴏᴜʀ ʀᴇǫᴜᴇsᴛ ɪs ʀᴇᴊᴇᴄᴛᴇᴅ 😶</b>", reply_to_message_id=int(msg_id))
        else:
            await query.answer(script.ALRT_TXT, show_alert=True)
        ...
        userid = query.from_user.id
        btn = [
            [InlineKeyboardButton("Uᴘʟᴏᴀᴅᴇᴅ ✅", callback_data=f"uploaded#{user_id}#{msg_id}")],
            [InlineKeyboardButton("Uɴᴀᴠᴀɪʟᴀʙʟᴇ 🙅", callback_data=f"not_available#{user_id}#{msg_id}"),
             InlineKeyboardButton("Aᴠᴀɪʟᴀʙʟᴇ 💞", callback_data=f"already_available#{user_id}#{msg_id}")],
            [InlineKeyboardButton("Nᴏᴛ Rᴇʟᴇᴀsᴇᴅ 📆", callback_data=f"year#{user_id}#{msg_id}"),
             InlineKeyboardButton("Sᴘᴇʟʟ Eʀʀᴏʀ ✍", callback_data=f"upload_in#{user_id}#{msg_id}")],
            [InlineKeyboardButton("❗ Cʟᴏsᴇ ❗", callback_data="close_data")]
        ]
        try:
            st = await client.get_chat_member(chnl_id, userid)
            ...
            await query.answer("⚠️ ʏᴏᴜ ᴀʀᴇ ɴᴏᴛ ᴀ ᴍᴇᴍʙᴇʀ ᴏꜰ ᴛʜɪs ᴄʜᴀɴɴᴇʟ, ꜰɪʀsᴛ ᴊᴏɪɴ", show_alert=True)
        ...
        userid = query.from_user.id
        buttons = [[
            InlineKeyboardButton("Uɴᴀᴠᴀɪʟᴀʙʟᴇ 🙅", callback_data=f"na_alert#{user_id}")
        ]]
        btn = [[
            InlineKeyboardButton("♻️ ᴠɪᴇᴡ sᴛᴀᴛᴜs ♻️", url=f"{query.message.link}")
        ]]
        ...
        if (st.status == enums.ChatMemberStatus.ADMINISTRATOR) or (st.status == enums.ChatMemberStatus.OWNER):
            ...
            await query.message.edit_reply_markup(InlineKeyboardMarkup(buttons))
            try:
                await client.send_message(chat_id=user_id, text="<b>Sᴏʀʀʏ Yᴏᴜʀ ʀᴇᴏ̨ᴜᴇsᴛ ɪs ᴜɴᴀᴠᴀɪʟᴀʙʟᴇ. Sᴏ ᴏᴜʀ ᴍᴏᴅᴇʀᴀᴛᴏʀs ᴄᴀɴ'ᴛ ᴜᴘʟᴏᴀᴅ ɪᴛ.</b>")
            except UserIsBlocked:
                await client.send_message(SUPPORT_GROUP, text=f"<b>💥 ʜᴇʟʟᴏ {user.mention},\n\nSᴏʀʀʏ Yᴏᴜʀ ʀᴇᴏ̨ᴜᴇsᴛ ɪs ᴜɴᴀᴠᴀɪʟᴀʙʟᴇ. Sᴏ ᴏᴜʀ ᴍᴏᴅᴇʀᴀᴛᴏʀs ᴄᴀɴ'ᴛ ᴜᴘʟᴏᴀᴅ ɪᴛ.</b>", reply_to_message_id=int(msg_id))
        else:
            await query.answer(script.ALRT_TXT, show_alert=True)
        ...
        userid = query.from_user.id
        buttons = [[
            InlineKeyboardButton("Uᴘʟᴏᴀᴅᴇᴅ ✅", callback_data=f"ul_alert#{user_id}")
        ]]
        btn = [[
            InlineKeyboardButton("Rᴇᴏ̨ᴜᴇsᴛ Gʀᴏᴜᴘ", url="https://t.me/ShadowMonarch_Group")
        ]]
        st = await client.get_chat_member(chnl_id, userid)
        if (st.status == enums.ChatMemberStatus.ADMINISTRATOR) or (st.status == enums.ChatMemberStatus.OWNER):
            user = await client.get_users(user_id)
            ...
            await query.message.edit_reply_markup(InlineKeyboardMarkup(buttons))
            try:
                await client.send_message(chat_id=user_id, text="<b>Yᴏᴜʀ ʀᴇᴏ̨ᴜᴇsᴛ ɪs ɴᴏᴡ Uᴘʟᴏᴀᴅᴇᴅ ᴏɴ ᴏᴜʀ ʙᴏᴛ's ᴅᴀᴛᴀʙᴀsᴇ. Kɪɴᴅʟʏ sᴇᴀʀᴄʜ ɪɴ ᴏᴜʀ Gʀᴏᴜᴘ.</b>", reply_markup=InlineKeyboardMarkup(btn))
            except UserIsBlocked:
                await client.send_message(SUPPORT_GROUP, text=f"<b>💥 ʜᴇʟʟᴏ {user.mention},\n\nYᴏᴜʀ ʀᴇᴏ̨ᴜᴇsᴛ ɪs ɴᴏᴡ Uᴘʟᴏᴀᴅᴇᴅ ᴏɴ ᴏᴜʀ ʙᴏᴛ's ᴅᴀᴛᴀʙᴀsᴇ. Kɪɴᴅʟʏ sᴇᴀʀᴄʜ ɪɴ ᴏᴜʀ Gʀᴏᴜᴘ.</b>", reply_markup=InlineKeyboardMarkup(btn), reply_to_message_id=int(msg_id))
        else:
            await query.answer(script.ALRT_TXT, show_alert=True)
        ...
        userid = query.from_user.id
        buttons = [[
            InlineKeyboardButton("Aʟʀᴇᴀᴅʏ Aᴠᴀɪʟᴀʙʟᴇ 💞", callback_data=f"aa_alert#{user_id}")
        ]]
        btn = [[
            InlineKeyboardButton("Rᴇᴏ̨ᴜᴇsᴛ Gʀᴏᴜᴘ", url="https://t.me/ShadowMonarch_Group")
        ]]
        ...
        if (st.status == enums.ChatMemberStatus.ADMINISTRATOR) or (st.status == enums.ChatMemberStatus.OWNER):
            ...
            await query.message.edit_reply_markup(InlineKeyboardMarkup(buttons))
            try:
                await client.send_message(chat_id=user_id, text="<b>Yᴏᴜʀ ʀᴇᴏ̨ᴜᴇsᴛ ɪs ᴀʟʀᴇᴀᴅʏ ᴀᴠᴀɪʟᴀʙʟᴇ ᴏɴ ᴏᴜʀ ʙᴏᴛ's ᴅᴀᴛᴀʙᴀsᴇ. Kɪɴᴅʟʏ sᴇᴀʀᴄʜ ɪɴ ᴏᴜʀ Gʀᴏᴜᴘ.</b>", reply_markup=InlineKeyboardMarkup(btn))
            except UserIsBlocked:
                await client.send_message(SUPPORT_GROUP, text=f"<b>💥 ʜᴇʟʟᴏ {user.mention},\n\nYᴏᴜʀ ʀᴇᴏ̨ᴜᴇsᴛ ɪs ᴀʟʀᴇᴀᴅʏ ᴀᴠᴀɪʟᴀʙʟᴇ ᴏɴ ᴏᴜʀ ʙᴏᴛ's ᴅᴀᴛᴀʙᴀsᴇ. Kɪɴᴅʟʏ sᴇᴀʀᴄʜ ɪɴ ᴏᴜʀ Gʀᴏᴜᴘ.</b>", reply_markup=InlineKeyboardMarkup(btn), reply_to_message_id=int(msg_id))
        else:
            await query.answer(script.ALRT_TXT, show_alert=True)
        ...
        userid = query.from_user.id
        buttons = [[
            InlineKeyboardButton("Sᴘᴇʟʟ Eʀʀᴏʀ ✍", callback_data=f"upload_alert#{user_id}")
        ]]
        btn = [[
            InlineKeyboardButton("Rᴇᴏ̨ᴜᴇsᴛ Gʀᴏᴜᴘ", url="https://t.me/ShadowMonarch_Group")
        ]]
        ...
        if (st.status == enums.ChatMemberStatus.ADMINISTRATOR) or (st.status == enums.ChatMemberStatus.OWNER):
            ...
            await query.message.edit_reply_markup(InlineKeyboardMarkup(buttons))
            try:
                await client.send_message(chat_id=user_id, text="<b>Iᴛ sᴇᴇᴍs ᴛʜᴀᴛ Yᴏᴜ ʜᴀᴅ ᴍᴀᴅᴇ ᴀ Sᴘᴇʟʟ Eʀʀᴏʀ ᴡʜɪʟᴇ sᴇᴀʀᴄʜɪɴɢ ʏᴏᴜʀ Rᴇǫᴜᴇsᴛ. Kɪɴᴅʟʏ sᴇᴀʀᴄʜ ᴡɪᴛʜ ᴄᴏʀʀᴇᴄᴛ sᴘᴇʟʟɪɴɢ ɪɴ ᴏᴜʀ Gʀᴏᴜᴘ.</b>", reply_markup=InlineKeyboardMarkup(btn))
            except UserIsBlocked:
                await client.send_message(SUPPORT_GROUP, text=f"<b>💥 ʜᴇʟʟᴏ {user.mention},\n\nIᴛ sᴇᴇᴍs ᴛʜᴀᴛ Yᴏᴜ ʜᴀᴅ ᴍᴀᴅᴇ ᴀ Sᴘᴇʟʟ Eʀʀᴏʀ ᴡʜɪʟᴇ sᴇᴀʀᴄʜɪɴɢ ʏᴏᴜʀ Rᴇǫᴜᴇsᴛ. Kɪɴᴅʟʏ sᴇᴀʀᴄʜ ᴡɪᴛʜ ᴄᴏʀʀᴇᴄᴛ sᴘᴇʟʟɪɴɢ ɪɴ ᴏᴜʀ Gʀᴏᴜᴘ.</b>", reply_markup=InlineKeyboardMarkup(btn), reply_to_message_id=int(msg_id))
        else:
            await query.answer(script.ALRT_TXT, show_alert=True)
        ...
        userid = query.from_user.id
        buttons = [[
            InlineKeyboardButton("Nᴏᴛ Rᴇʟᴇᴀsᴇᴅ 📆", callback_data=f"yrs_alert#{user_id}")
        ]]
        btn = [[
            InlineKeyboardButton("♻️ ᴠɪᴇᴡ sᴛᴀᴛᴜs ♻️", url=f"{query.message.link}")
        ]]
        ...
        if (st.status == enums.ChatMemberStatus.ADMINISTRATOR) or (st.status == enums.ChatMemberStatus.OWNER):
            ...
            await query.message.edit_reply_markup(InlineKeyboardMarkup(buttons))
            try:
                await client.send_message(chat_id=user_id, text="<b>Yᴏᴜʀ ʀᴇᴏ̨ᴜᴇsᴛ ɪs Nᴏᴛ Rᴇʟᴇᴀsᴇᴅ Yᴇᴛ. Sᴏ ᴏᴜʀ ᴍᴏᴅᴇʀᴀᴛᴏʀs ᴄᴀɴ'ᴛ ᴜᴘʟᴏᴀᴅ ɪᴛ.</b>")
            except UserIsBlocked:
                await client.send_message(SUPPORT_GROUP, text=f"<b>💥 ʜᴇʟʟᴏ {user.mention},\n\nYᴏᴜʀ ʀᴇᴏ̨ᴜᴇsᴛ ɪs Nᴏᴛ Rᴇʟᴇᴀsᴇᴅ Yᴇᴛ. Sᴏ ᴏᴜʀ ᴍᴏᴅᴇʀᴀᴛᴏʀs ᴄᴀɴ'ᴛ ᴜᴘʟᴏᴀᴅ ɪᴛ.</b>", reply_to_message_id=int(msg_id))
        else:
            await query.answer(script.ALRT_TXT, show_alert=True)
        ...
        userid = query.from_user.id
        if str(userid) in user_id:
            await query.answer("Yᴏᴜʀ Rᴇᴏ̨ᴜᴇsᴛ ʜᴀs ᴀ sᴘᴇʟʟ Eʀʀᴏʀ !", show_alert=True)
        else:
            await query.answer(script.ALRT_TXT, show_alert=True)
        ...
        userid = query.from_user.id
        if str(userid) in user_id:
            await query.answer("Yᴏᴜʀ Rᴇᴏ̨ᴜᴇsᴛ ɪs Nᴏᴛ Rᴇʟᴇᴀsᴇᴅ Yᴇᴛ !", show_alert=True)
        else:
            await query.answer(script.ALRT_TXT, show_alert=True)
