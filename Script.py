import os
class script(object):
    START_TXT = """<b>Hᴇʏ {} , {}\n\nɪ ᴀᴍ ᴀ ᴘᴏᴡᴇʀꜰᴜʟ & ꜰᴜʟʟʏ ᴄᴜꜱᴛᴏᴍɪᴢᴀʙʟᴇ ᴀᴜᴛᴏ ꜰɪʟᴛᴇʀ ʙᴏᴛ ᴡɪᴛʜ ᴀᴅᴠᴀɴᴄᴇ ꜰᴇᴀᴛᴜʀᴇꜱ.\nJᴜꜱᴛ ꜱᴇɴᴅ ᴀɴʏ ᴍᴏᴠɪᴇ ᴏʀ ꜱᴇʀɪᴇꜱ ɴᴀᴍᴇ ᴀɴᴅ ɢᴇᴛ ʏᴏᴜʀ ғɪʟᴇ !!\n\n<blockquote>★ Mᴀɪɴᴛᴀɪɴᴇᴅ ʙʏ : <a href="https://t.me/its_TSMSupport_bot">Tᴜꜱʜᴀʀ Pᴀᴛᴇʟ</a></blockquote></b>"""
...
<u>ɴᴏᴛᴇ</u> - ᴛʜɪs ᴄᴏᴍᴍᴀɴᴅ ᴡᴏʀᴋ ɪɴ ʙᴏᴛʜ ɢʀᴏᴜᴘs ᴀɴᴅ ʙᴏᴛ ᴘᴍ</b>"""
...
<u>Ex</u>: <code>/fsub -100xxxxxx</code>

ɴᴏᴡ ɪᴛ's ᴅᴏɴᴇ. ɪ ᴡɪʟʟ ғᴏʀᴄᴇ ʏᴏᴜʀ ᴜsᴇʀs ᴛᴏ ᴊᴏɪɴ ʏᴏᴜʀ ᴄʜᴀɴɴᴇʟ/ɢʀᴏᴜᴘ, ᴀɴᴅ I ᴡɪʟʟ ɴᴏᴛ ᴘʀᴏᴠɪᴅᴇ ᴀɴʏ ғɪʟᴇs ᴜɴᴛɪʟ ʏᴏᴜʀ ᴜsᴇʀs ᴊᴏɪɴ ʏᴏᴜʀ ᴛᴀʀɢᴇᴛ ᴄʜᴀɴɴᴇʟ.
...
<b>• sᴇɴᴅ /tts ᴛᴏ ᴜsᴇ ᴛʜɪs ғᴇᴀᴛᴜʀᴇ</b>"""
    ...
    DISCLAIMER_TXT = """<b> ᴛʜɪs ɪs ɴᴏᴛ ᴀɴ ᴏᴘᴇɴ sᴏᴜʀᴄᴇ ᴘʀᴏᴊᴇᴄᴛ.

<blockquote><i>ᴀʟʟ ᴛʜᴇ ꜰɪʟᴇs ɪɴ ᴛʜɪs ʙᴏᴛ ᴀʀᴇ ꜰʀᴇᴇʟʏ ᴀᴠᴀɪʟᴀʙʟᴇ ᴏɴ ᴛʜᴇ ɪɴᴛᴇʀɴᴇᴛ ᴏʀ ᴘᴏsᴛᴇᴅ ʙʏ sᴏᴍᴇʙᴏᴅʏ ᴇʟsᴇ. ᴊᴜsᴛ ꜰᴏʀ ᴇᴀsʏ sᴇᴀʀᴄʜɪɴɢ ᴛʜɪs ʙᴏᴛ ɪs ɪɴᴅᴇxɪɴɢ ꜰɪʟᴇs ᴡʜɪᴄʜ ᴀʀᴇ ᴀʟʀᴇᴀᴅʏ ᴜᴘʟᴏᴀᴅᴇᴅ ᴏɴ ᴛᴇʟᴇɢʀᴀᴍ. ᴡᴇ ʀᴇsᴘᴇᴄᴛ ᴀʟʟ ᴛʜᴇ ᴄᴏᴘʏʀɪɢʜᴛ ʟᴀᴡs ᴀɴᴅ ᴡᴏʀᴋs ɪɴ ᴄᴏᴍᴘʟɪᴀɴᴄᴇ ᴡɪᴛʜ ᴅᴍᴄᴀ ᴀɴᴅ ᴇᴜᴄᴅ. ɪꜰ ᴀɴʏᴛʜɪɴɢ ɪs ᴀɢᴀɪɴsᴛ ʟᴀᴡ ᴘʟᴇᴀsᴇ ᴄᴏɴᴛᴀᴄᴛ ᴍᴇ sᴏ ᴛʜᴀᴛ ɪᴛ ᴄᴀɴ ʙᴇ ʀᴇᴍᴏᴠᴇᴅ ᴀsᴀᴘ. ɪᴛ ɪs ꜰᴏʀʙɪᴅᴅᴇɴ ᴛᴏ ᴅᴏᴡɴʟᴏᴀᴅ, sᴛʀᴇᴀᴍ, ʀᴇᴘʀᴏᴅᴜᴄᴇ, sʜᴀʀᴇ ᴏʀ ᴄᴏɴsᴜᴍᴇ ᴄᴏɴᴛᴇɴᴛ ᴡɪᴛʜᴏᴜᴛ ᴇxᴘʟɪᴄɪᴛ ᴘᴇʀᴍɪssɪᴏɴ ꜰʀᴏᴍ ᴛʜᴇ ᴄᴏɴᴛᴇɴᴛ ᴡɪᴛʜᴏᴜᴛ ᴇxᴘʟɪᴄɪᴛ ᴘᴇʀᴍɪssɪᴏɴ ꜰʀᴏᴍ ᴛʜᴇ ᴄᴏɴᴛᴇɴᴛ ᴄʀᴇᴀᴛᴏʀ ᴏʀ ʟᴇɢᴀʟ ᴄᴏᴘʏʀɪɢʜᴛ ʜᴏʟᴅᴇʀ. ɪꜰ ʏᴏᴜ ʙᴇʟɪᴇᴠᴇ ᴛʜɪs ʙᴏᴛ ɪs ᴠɪᴏʟᴀᴛɪɴɢ ʏᴏᴜʀ ɪɴᴛᴇʟʟᴇᴄᴛᴜᴀʟ ᴘʀᴏᴘᴇʀᴛʏ, ᴄᴏɴᴛᴀᴄᴛ ᴛʜᴇ ʀᴇsᴘᴇᴄᴛɪᴠᴇ ᴄʜᴀɴɴᴇʟs ꜰᴏʀ ʀᴇᴍᴏᴠᴀʟ. ᴛʜᴇ ʙᴏᴛ ᴅᴏᴇs ɴᴏᴛ ᴏᴡɴ ᴀɴʏ ᴏꜰ ᴛʜᴇsᴇ ᴄᴏɴᴛᴇɴᴛs, ɪᴛ ᴏɴʟʏ ɪɴᴅᴇx ᴛʜᴇ ꜰɪʟᴇs ꜰʀᴏᴍ ᴛᴇʟᴇɢʀᴀᴍ.</i></blockquote>

★ <u>Mᴀɪɴᴛᴀɪɴᴇᴅ ʙʏ</u> : <a href='https://t.me/its_TSMSupport_bot'>Tᴜsʜᴀʀ Pᴀᴛᴇʟ</a></b>"""
    

    ABOUT_TEXT = """<blockquote><b>╭─────[ Eʟɪᴛᴇ ™ ]─────〆
│🤖 ᴍʏ ɴᴀᴍᴇ : <a href=https://t.me/Elite_TSM_bot>Eʟɪᴛᴇ</a>
│👤 ᴅᴇᴠᴇʟᴏᴘᴇʀ : <a href='https://t.me/its_TSMSupport_bot'>Tᴜsʜᴀʀ Pᴀᴛᴇʟ</a> 
│📚 ʟɪʙʀᴀʀʏ : <a href='https://docs.pyrogram.org/'>Pʏʀᴏɢʀᴀᴍ</a>
│⚙️ ʟᴀɴɢᴜᴀɢᴇ : <a href='https://www.python.org/'>Pʏᴛʜᴏɴ 𝟹</a> 
│♻️ ᴅᴀᴛᴀʙᴀꜱᴇ : <a href='https://www.mongodb.com/'>Mᴏɴɢᴏ DB</a> 
│🚀 ʙᴏᴛ ꜱᴇʀᴠᴇʀ : <a href='https://heroku.com/'>Hᴇʀᴏᴋᴜ</a>
│🌐 ʙᴜɪʟᴅ ᴠᴇʀꜱɪᴏɴ : V5.2 [Sᴛᴀʙʟᴇ]
╰────────────────〆</b></blockquote>"""    
...
BOT WORKING PROPERLY 🔥"""
    ...
    RESTART_TXT = """
<b>Bᴏᴛ Rᴇsᴛᴀʀᴛᴇᴅ !  ( <a href=https://t.me/Elite_TSM_bot>ELITE</a> )
...
"""
    ...
    FILE_CAPTION = """<b><u>Nᴀᴍᴇ</u></b> : {file_name}"""
    

    ALRT_TXT = """ᴛʜɪs ɪs ɴᴏᴛ ʏᴏᴜʀ ᴍᴏᴠɪᴇ ʀᴇǫᴜᴇsᴛ,
Rᴇǫᴜᴇsᴛ ʏᴏᴜʀs..."""

    OLD_ALRT_TXT = """ʏᴏᴜ ᴀʀᴇ ᴜsɪɴɢ ᴍʏ ᴏʟᴅ ᴍᴇssᴀɢᴇs...sᴇɴᴅ ᴀ ɴᴇᴡ ʀᴇǫᴜᴇsᴛ.."""

    NO_RESULT_TXT = """<b>ᴛʜɪs ᴍᴇssᴀɢᴇ ɪs ɴᴏᴛ ʀᴇʟᴇᴀsᴇᴅ ᴏʀ ɴᴏᴛ ᴀᴠᴀɪʟᴀʙʟᴇ ɪɴ ᴍʏ ᴅᴀᴛᴀʙᴀsᴇ 🙄

Pʟᴇᴀsᴇ ʀᴇᴄʜᴇᴄᴋ sᴘᴇʟʟɪɴɢ !!

•─────•──────•─────•

Sᴇɴᴅ ʏᴏᴜʀ ʀᴇǫᴜᴇsᴛ ʙʏ ᴜsɪɴɢ #request ᴄᴏᴍᴍᴀɴᴅ ᴀs -
<code>#request Movie-name</code></b>"""
...
❏ ꜰᴜʟʟ ᴀᴅᴍɪɴ sᴜᴘᴘᴏʀᴛ                              
❏ ʀᴇǫᴜᴇsᴛ ᴡɪʟʟ ʙᴇ ᴄᴏᴍᴘʟᴇᴛᴇᴅ ᴡɪᴛʜɪɴ ғᴇᴡ ʜᴏᴜʀꜱ [ ɪꜰ ᴀᴠᴀɪʟᴀʙʟᴇ ]
...
🏆 ɪꜰ ʏᴏᴜ ᴡᴀɴᴛ ᴀ ɴᴇᴡ ᴘʟᴀɴ ᴀᴘᴀʀᴛ ꜰʀᴏᴍ ᴛʜᴇ ɢɪᴠᴇɴ ᴘʟᴀɴ, ᴛʜᴇɴ ʏᴏᴜ ᴄᴀɴ ᴛᴀʟᴋ ᴛᴏ ᴏᴜʀ <a href='https://t.me/its_TSMSupport_bot'>ᴏᴡɴᴇʀ</a> ᴅɪʀᴇᴄᴛʟʏ ʙʏ ᴄʟɪᴄᴋɪɴɢ ᴏɴ ᴛʜᴇ ᴄᴏɴᴛᴀᴄᴛ ʙᴜᴛᴛᴏɴ ɢɪᴠᴇɴ ʙᴇʟᴏᴡ.
...
🆔 ᴜᴘɪ ɪᴅ ➩ <code>not available...</code> [ᴛᴀᴘ ᴛᴏ ᴄᴏᴘʏ]
...
-------------------------------------
➩ /invite {channel-id} - Create invite link of channel
➩ /search {movie-name} - Search a movie in database
--------------Movie Updates--------------
➩ /movie_update_on - Turn on movie updates 
➩ /movie_update_off - Turn off movie updates

</blockquote></b>"""
    

    GRC_TEXT = """<b><blockquote>
 --------------Set Verify-------------
...
--------------Verify On Off------------
/verifyoff {{verify.off code}} - off verification <a href="https://t.me/its_TSMSupport_bot">Cᴏɴᴛᴀᴄᴛ</a> ᴛʜᴇ ʙᴏᴛ ᴀᴅᴍɪɴ ғᴏʀ ᴀ ᴠᴇʀɪғʏ.ᴏғғ ᴄᴏᴅᴇ
/verifyon - on verification 
------------Set File Caption-----------
/set_caption - set coustom file caption 
-----------Set Imdb Template-----------
/set_template - set IMDb template <a href="https://t.me/its_TSMSupport_bot">Example</a>
--------------Set Tutorial-------------
...
Iғ ʏᴏᴜ ʜᴀᴠᴇ ᴀɴʏ ᴅᴏᴜʙᴛs ᴘʟᴇᴀsᴇ <a href="https://t.me/its_TSMSupport_bot">ᴄᴏɴᴛᴀᴄᴛ</a> ᴍʏ <a href="https://t.me/its_TSMSupport_bot">ᴀᴅᴍɪɴ</a></b>"""
